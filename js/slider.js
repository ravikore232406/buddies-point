    ...
    return this.each(function () {
      var full = $(this),
        ...
        move = function (direction, current) {
          ...
          if (direction === "right") {
            status.current =
              status.current + 1 > status.max ? 0 : status.current + 1;
          } else if (direction === "left") {
            status.current =
              status.current - 1 < 0 ? status.max : status.current - 1;
          } else {
        ...
        resize = function () {
          var wWidth = $(window).width(),
            ...
            imageCSS =
              wWidth <= smallest ? ["100%", "auto", "9999"] : ["", "", ""],
            start = inner.height(),
            divCSS = wWidth <= 480 ? ["0", "100%", "none"] : ["", "", ""],
            size = wWidth / 41;

          size =
            size > settings.maxFont
              ? settings.maxFont
              : size < settings.minFont
              ? settings.minFont
              : size;
          ...
          var paddH =
            $(".slide-desc").innerHeight() - $(".slide-desc").height();
          ...
          if (wWidth > 1500) {
            ...
            $(".controls a.left").css({
              "margin-left": function () {
                var marginLeft =
                  ($(".slide-desc").width() + paddT + 4) / 2 + 101;
      ...
      (function () {
        ...
        slides
          .css("width", parseFloat(100 / slides.length, 10) + "%")
          .each(function (i) {
